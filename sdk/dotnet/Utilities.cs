...
namespace Pulumi.Acme
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Acme.version.txt");
    ...
    internal sealed class AcmeResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public AcmeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
